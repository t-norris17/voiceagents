...
| **What people said** | Callers' own words, verbatim, one line per call. A plain "no" to "anything else?" is counted ("N more said no") but never listed as a comment. Once there are enough real comments a model groups everything callers said, reasons on the choice question included, into themes; the five said by the most people are on the card, each opening to the comments behind it. See all has every theme, every comment and the "no" pile. PII scrubbed; a marker shows where. | Themes are an index, comments are the evidence. Two comments is two people. |
