...
- **KB gap** — the documents do not say; the correct behaviour is "not certain, offer to connect".

## Scenarios

| # | Question | Expected answer | Source | Verified |
|---|---|---|---|---|
| 1 | The rules, and how much | Plan allows loans; lesser of $50,000 or 50% of vested balance; one at a time; he already has one; today about $9,561 on $19,122.70 vested | Loans KB + `get_balance` | Limits and one-loan rule **Observed** `conv_8301m28d4f7zfeja4k2ycd9mb9eh` at 111s and 198s. The "what are the rules" framing is new and unheard |
| 1 | Is there a minimum | $1,000 | Loans KB | In KB |
| 1 | Can I still put money in while paying a loan back | Yes. Contributions and the employer match continue; loan repayments are a separate after-tax payroll deduction, are not contributions, earn no match, and don't count toward the IRS limit. Pausing contributions does not pause loan payments | Loans KB, "Contributing while you have a loan" — **added 2026-09-14** (`kb/vertex/vertex-401k-loans.md`, pushed live to `omgR8I0aJlWd7BAUptbJ`, RAG re-queried and the new section is the top chunk) | In KB. Was a **KB gap** until 2026-09-14; before that the correct behaviour was "not certain, offer to connect". **The CTO's question; read for it in transcripts** |
| 5 | Can I pay it off early (not on the handout, but the natural follow-up to "what do I do to borrow again") | Yes, in full, any time, no prepayment penalty, via portal or participant line; then a new loan can be requested. No partial extra payments through payroll | Loans KB, "Paying a loan off early" — **added 2026-09-14** | In KB, unheard |
...
| 4 | What it costs | Prime + 1%, fixed for the life of the loan; cannot quote Prime today; his current loan is 8.5% | Loans KB + `get_balance.loan.interest_rate` | **Observed** 198s and 281s |
...
Dropped from the previous draft: "how do I pay it back" (after-tax payroll deductions, In KB,
unheard). Scenario 4 now has two follow-ups instead of four.
...
1. **Where a transfer rings.** `transfer_to_number` on the live agent points at `+13166807638`,
   ...
   there once. Tanner is changing the destination before the wave.
