...
seconds for two quick questions about how this went?" If yes, ask them ONE AT A TIME, waiting for
each answer:
1. "On a scale of one to five, how satisfied are you with how this call went?"
2. "And did we take care of what you called about today?"
Then, only if they answered both: "Last thing — would it be alright if we called you back another
time to ask a couple more? No problem at all either way." If they say yes, ask when suits them
("any particular time of day work better?") and take whatever they say.
...
If they decline, say "no problem at all" and move straight to goodbye. Never ask twice, never
re-word it and try again, and never let the survey delay ending the call. A survey is a favour they
are doing you — it is never worth spending their patience on.
